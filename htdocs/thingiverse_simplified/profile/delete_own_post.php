...
// Prüfen, ob die Kreation dem aktuellen Benutzer gehört
$stmt = $pdo->prepare("
    SELECT id 
    FROM kreationen
    WHERE id = :id
...
// Optional: Zuerst alle zugehörigen Dateien löschen, falls du das manuell machen möchtest
